env.info("--- SKYNET VERSION: baron-branch-modified | BUILD TIME: 16.05.2023 0646Z ---")
...
--- Start of 2SAP & Radar Dome Mod EW radars
...
function SkynetIADS:addRadioMenu()
	self.radioMenu = missionCommands.addSubMenu('SKYNET IADS '..self:getCoalitionString(), utilsToolsMenu)
...
jammer.jammerTable = {
	...
	['CSA-4'] = {
		...
		['SA-5'] = {
			['function'] = function(distanceNauticalMiles) return ( 1.15 ^ distanceNauticalMiles ) + 10 end,
			['canjam'] = true,
		},
		['SA-6'] = {
		...
		['SA-17'] = {
			['function'] = function(distanceNauticalMiles) return ( 1.10 ^ distanceNauticalMiles ) + 10 end,
			['canjam'] = true,
		},
		['SA-20A'] = {
			['function'] = function(distanceNauticalMiles) return ( 1.07 ^ (distanceNauticalMiles / 1.2) ) + 5 end,
			['canjam'] = true,
		},
		['SA-20B'] = {
			['function'] = function(distanceNauticalMiles) return ( 1.07 ^ (distanceNauticalMiles / 1.2) ) + 5 end,
		...
		['SA-23B'] = {
			['function'] = function(distanceNauticalMiles) return ( 1.07 ^ (distanceNauticalMiles / 1.22) ) + 0 end,
			['canjam'] = true,
		},
		['SA-23'] = {
			['function'] = function(distanceNauticalMiles) return ( 1.07 ^ (distanceNauticalMiles / 1.22) ) + 0 end,
...
if iads_radio_menu_enable == true then
