...
--CHANGE LIVERIES AND TYPES OF THESE STATICS HERE:
static_cvn_seahawk_livery = "standard"
static_cvn_e2d_livery = "E-2D Demo"

static_block_el3_tomcat_type = "F-14B" -- or use "F-14A-135-GR"
static_block_el3_tomcat_livery = "VF-32 Fighting Swordsmen 102" --make sure if F14A, use proper livery!

static_block_patio_hornet_livery = "VFA-106"

static_block_island_hornet_livery = "VFA-97"

static_el1_hornet_livery = "VFA-37"
static_el2_hornet_livery = "VFA-37"
static_el2_s3b_livery = "usaf standard"

static_el4_tomcat_type = "F-14B" -- or use "F-14A-135-GR"
static_el4_tomcat_livery = "VF-102 Diamondbacks" --make sure if F14A, use proper livery!

static_point_hornet_livery = "VFA-37"

static_block_patio_tomcat_type = "F-14B" -- or use "F-14A-135-GR"
static_block_patio_tomcat_livery = "VF-102 Diamondbacks" --make sure if F14A, use proper livery!

static_launch_tomcat_type = "F-14B" -- or use "F-14A-135-GR"
static_launch_tomcat_livery = "VF-32 Fighting Swordsmen 101"

static_mass_recover_tomcat_type = "F-14B" -- or use "F-14A-135-GR"
static_mass_recover_tomcat_livery = "VF-103 Last Ride"

static_mass_recover_tomcat_1_type = "F-14B" -- or use "F-14A-135-GR"
static_mass_recover_tomcat_1_livery = "VF-24 Renegades"

static_mass_recover_tomcat_3_type = "F-14B" -- or use "F-14A-135-GR"
static_mass_recover_tomcat_3_livery = "VF-143 Pukin Dogs Low Vis"

static_mass_recover_tomcat_4_type = "F-14B" -- or use "F-14A-135-GR"
static_mass_recover_tomcat_4_livery = "VF-211 Fighting Checkmates"

static_mass_recover_tomcat_6_type = "F-14B" -- or use "F-14A-135-GR"
static_mass_recover_tomcat_6_livery = "VF-74 BeDevilers 1991"

--shipIDnumber = staticCarrerGetGroupId(Unit.getByName("CVN-7X"))
if carrierCvnExist == true then
	shipID = Unit.getByName("CVN-7X"):getID()
else
	tti.debug("Setting SC Deck Spawns debug/faux ID for CVN Carrier due to error")
	shipID = 12345678
end
if carrierKuzExist == true then
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_cvn_seahawk_livery,
...
-- Copy and paste over this with the units information
                                       ["livery_id"] = static_cvn_e2d_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = 19.286680730002,
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_block_el3_tomcat_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = 33.290550209989,
                                        ...
                                        ["type"] = static_block_el3_tomcat_type,
-- Copy and paste over this with the units information end
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_block_patio_hornet_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = 26.055655829958,
...
local staticObj = {
	...
	["category"] = "Planes",
	["livery_id"] = static_el1_hornet_livery,
...
local staticObj = {
	...
	["category"] = "Planes",
	["livery_id"] = static_el2_s3b_livery,
...
-- Segment you need to change start  
	...
	["unitId"] = 1,
	["name"] = static_el2_hornet_livery, -- unit name (Name this something identifiable if you wish to remove it later)
...
-- Segment you need to change start  
	...
	["name"] = "4temp EL4 Tomcat 1", -- unit name (Name this something identifiable if you wish to remove it later)
                                        ...
                                        ["livery_id"] = static_el4_tomcat_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = -32.180430089997,
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_point_hornet_livery,
                                        ["category"] = "Planes",
                                        ["type"] = "FA-18C_hornet",
                                        ["offsets"] = 
                                        {
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_block_patio_tomcat_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = 26.834156429977,
                                        ...
                                        ["type"] = static_block_patio_tomcat_type,
-- Copy and paste over this with the units information end
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_block_island_hornet_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = 17.046432009956,
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_launch_tomcat_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = -7.4492495800368,
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_mass_recover_tomcat_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = 9.8766481691273,
                                        ...
                                        ["type"] = static_mass_recover_tomcat_type,
-- Copy and paste over this with the units information end
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_mass_recover_tomcat_1_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = 13.348785758601,
                                        ...
                                        ["type"] = static_mass_recover_tomcat_1_type,
-- Copy and paste over this with the units information end
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_mass_recover_tomcat_3_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = -9.2750407750136,
                                        ...
                                        ["type"] = static_mass_recover_tomcat_3_type,
-- Copy and paste over this with the units information end
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_mass_recover_tomcat_4_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = -8.3027975242003,
                                        ...
                                        ["type"] = static_mass_recover_tomcat_4_type,
-- Copy and paste over this with the units information end
...
-- Copy and paste over this with the units information
                                        ["livery_id"] = static_mass_recover_tomcat_6_livery,
                                        ["category"] = "Planes",
                                        ["offsets"] = 
                                        {
                                            ["y"] = -2.2444017659291,
                                        ...
                                        ["type"] = static_mass_recover_tomcat_6_type,
-- Copy and paste over this with the units information end
...
function spawnCvnDeckTemplate()
timer.scheduleFunction(function()
	if enable_sc_cvn_deck_template_on_start == true and cv_cvn_spawned == true then
		--if mission_era == "modern" or mission_era == "cold_war" then
			if cvnTypeName == "CVN_71" or 
				cvnTypeName == "CVN_72" or 
				cvnTypeName == "CVN_73" or 
				cvnTypeName == "CVN_74" or 
				cvnTypeName == "CVN_75" then 
				sc16SpawnsClearDeck()
				sc8SpawnsClearDeck()
				tti.debug("Starting static CVN deck template...")
			end
		--end
	end
end, nil, timer.getTime() + 2  )
end
spawnCvnDeckTemplate()
