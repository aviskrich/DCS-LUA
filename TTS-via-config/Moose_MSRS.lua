 ...
 MSRS_Config = {
  ...
  Backend = "grpc",     -- Interface to SRS: "srsexe" or "grpc".
  ...
  -- Google Cloud
  gcloud = {
    voice = "ru-RU-Standard-B", -- The Google Cloud voice to use (see https://cloud.google.com/text-to-speech/docs/voices).
    credentials=[[C:\Program Files\DCS-SimpleRadio-Standalone\google.json]], -- Full path to credentials JSON file (only for SRS-TTS.exe backend)
    key="AIzaSyCr2SXcxGYv6bua-4-zI3fxjvdwEyK2_7I", -- Google API access key (only for DCS-gRPC backend)
  },
  -- Amazon Web Service
  aws = {
