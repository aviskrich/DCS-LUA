...
----[[ ##### SCRIPT CONFIGURATION ##### ]]----
    ...
    explTable = {
      ...
      ["British_GP_250LB_Bomb_Mk1"] = 50,           --("250 lb GP Mk.I")
      ["British_GP_250LB_Bomb_Mk4"] = 50,           --("250 lb GP Mk.IV")
      ["British_GP_250LB_Bomb_Mk5"] = 50,           --("250 lb GP Mk.V")
      ["British_GP_500LB_Bomb_Mk1"] = 113,           --("500 lb GP Mk.I")
      ["British_GP_500LB_Bomb_Mk4"] = 113,           --("500 lb GP Mk.IV")
      ["British_GP_500LB_Bomb_Mk4_Short"] = 113,     --("500 lb GP Short tail")
      ["British_GP_500LB_Bomb_Mk5"] = 113,           --("500 lb GP Mk.V")
      ["British_MC_250LB_Bomb_Mk1"] = 50,           --("250 lb MC Mk.I")
      ["British_MC_250LB_Bomb_Mk2"] = 50,           --("250 lb MC Mk.II")
      ["British_MC_500LB_Bomb_Mk1_Short"] = 113,     --("500 lb MC Short tail")
      ["British_MC_500LB_Bomb_Mk2"] = 113,           --("500 lb MC Mk.II")
      ["British_SAP_250LB_Bomb_Mk5"] = 50,          --("250 lb S.A.P.")
      ["British_SAP_500LB_Bomb_Mk5"] = 105,          --("500 lb S.A.P.")
      ["British_AP_25LBNo1_3INCHNo1"] = 2,           --("RP-3 25lb AP Mk.I")
      ["British_HE_60LBSAPNo2_3INCHNo1"] = 2,        --("RP-3 60lb SAP No2 Mk.I")
      ["British_HE_60LBFNo1_3INCHNo1"] = 2,          --("RP-3 60lb F No1 Mk.I")
      ["WGr21"] = 2,                                 --("Werfer-Granate 21 - 21 cm UnGd air-to-air rocket")
      ["3xM8_ROCKETS_IN_TUBES"] = 2,                 --("4.5 inch M8 UnGd Rocket")
      ["AN_M30A1"] = 25,                             --("AN-M30A1 - 100lb GP Bomb LD")
      ["AN_M57"] = 50,                              --("AN-M57 - 250lb GP Bomb LD")
      ["AN_M65"] = 200,                              --("AN-M65 - 1000lb GP Bomb LD")
      ["AN_M66"] = 400,                              --("AN-M66 - 2000lb GP Bomb LD")
      ["SC_50"] = 10,                                --("SC 50 - 50kg GP Bomb LD")
      ["ER_4_SC50"] = 10,                            --("4 x SC 50 - 50kg GP Bomb LD")
      ["SC_250_T1_L2"] = 50,                        --("SC 250 Type 1 L2 - 250kg GP Bomb LD")
      ["SC_501_SC250"] = 50,                        --("SC 250 Type 3 J - 250kg GP Bomb LD")
      ["Schloss500XIIC1_SC_250_T3_J"] = 50,         --("SC 250 Type 3 J - 250kg GP Bomb LD")
      ["SC_501_SC500"] = 105,                        --("SC 500 J - 500kg GP Bomb LD")
      ["SC_500_L2"] = 105,                           --("SC 500 L2 - 500kg GP Bomb LD")
      ["SD_250_Stg"] = 25,                          --("SD 250 Stg - 250kg GP Bomb LD")
      ["SD_500_A"] = 213,                            --("SD 500 A - 500kg GP Bomb LD")
      ["AB_250_2_SD_2"] = 55,                       --("AB 250-2 - 144 x SD-2, 250kg CBU with HE submunitions")
      ["AB_250_2_SD_10A"] = 55,                     --("AB 250-2 - 17 x SD-10A, 250kg CBU with 10kg Frag/HE submunitions")
      ["AB_500_1_SD_10A"] = 113,                     --("AB 500-1 - 34 x SD-10A, 500kg CBU with 10kg Frag/HE submunitions")
      ["HYDRA_70_M229"] = 3,
                            -- A10C APKWS  															 
      ["GBU_54_V_1B"] = 50,
      ["SNEB_TYPE251_F1B"] = 1,
      ...
      ["SNEB_TYPE257_H1"] = 2,
                                   -- CBUs
      ["MATRA_F4_SNEBT251"] = 2,                    -- Mirage F1 Section
      ["MATRA_F4_SNEBT253"] = 2,
      ["MATRA_F4_SNEBT256"] = 2,
      ["MATRA_F1_SNEBT253"] = 2,
      ["MATRA_F1_SNEBT256"] = 2,
      ...
      ["Durandal"] = 64,
      ["BLU107B_DURANDAL"] = 100,
      ["FFAR Mk5 HEAT"] = 3,                        -- Rockets
      ["FFAR Mk1 HE"] = 2,
      ["C5"] = 1,                                    -- Mig19P Rockets
